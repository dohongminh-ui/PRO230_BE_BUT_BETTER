...
import com.pheobe.component.Message;
import com.pheobe.component.PanelCover;
import com.pheobe.component.PanelLoading;
    ...
    private void register() {
        ...
        try {
            if (service.checkDuplicateUser(user.getUserName())) {
                showMessage(Message.MessageType.ERROR, "Username already exist");
